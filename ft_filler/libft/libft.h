...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/11/05 06:57:47 by momartin          #+#    #+#             */
/*   Updated: 2016/12/14 22:23:48 by momartin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					ft_set_mat_elem(t_matrix *m, unsigned int row,
									unsigned int col, float val);
int					ft_get_mat_elem(t_matrix *m, unsigned int row,
									unsigned int col, float *val);
