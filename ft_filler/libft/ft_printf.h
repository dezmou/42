...
void				handle_width(t_printf_env *e);
void				handle_precision(t_printf_env *e);
void				handle_length(t_printf_env *e);
void				handle_specifier(t_printf_env *e);
void				get_more_width(t_printf_env *e);
void				get_more_prec(t_printf_env *e);
void				apply(t_printf_env *e);
void				apply_int(t_printf_env *e);
void				apply_str(t_printf_env *e);
void				apply_ptr(t_printf_env *e);
void				apply_char(t_printf_env *e);
void				apply_unsigned(t_printf_env *e);
void				apply_hex_big(t_printf_env *e);
void				apply_hex_short(t_printf_env *e);
void				apply_octal(t_printf_env *e);
void				apply_percent(t_printf_env *e);
void				apply_wstr(t_printf_env *e);
void				apply_hex_zero_octal(t_printf_env *e, char *prefix);
void				apply_width(t_printf_env *e);
void				apply_width_dec(t_printf_env *e);
void				apply_precision(t_printf_env *e);
void				apply_precision_str(t_printf_env *e);
void				apply_width_wstr(t_printf_env *e, wchar_t *str);
void				apply_hex_final(t_printf_env *e);
void				apply_length(t_printf_env *e);
void				apply_wchar(t_printf_env *e);
void				apply_invalid(t_printf_env *e);
void				apply_wstr(t_printf_env *e);
long				get_nbr_with_len(t_printf_env *e);
long				get_u_nbr_with_len(t_printf_env *e);
